...
### [ Task ]
  1. `radio` buttons used for case that we have questions and want only one answer out of multiple options.
  2.  add a radio button with the option set as: `Indoor`
