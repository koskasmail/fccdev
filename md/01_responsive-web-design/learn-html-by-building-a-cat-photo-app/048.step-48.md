...
### [ Task ]
  1. Radio buttons are presented in radio groups and share the same `name` attribute.
  2. Add the `name` attribute with the value `indoor-outdoor` to both radio buttons.
