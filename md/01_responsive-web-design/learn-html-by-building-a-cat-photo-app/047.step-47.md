...
### [ Task ]
  1. Create another radio button below the first one.
  2. Nest it inside a `label` element with `Outdoor` as the label text.
  3. Give the radio button an `id` attribute with `outdoor` as the value.
